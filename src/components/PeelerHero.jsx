        ...
        <section id="home" className={`flex md:flex-row flex-col  ${styles.paddingY}`}>
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0   sm:px-16 `}>
                <div className='flex flex-row justify-between items-center w-full'>
                    <h1 className='flex-1 font-poppins font-semibold ss:text-[72px] ph:text-[45px] bph:text-[44px] text-[52px]  dark-text ss:leading-[95px] leading-[65px]'>
                        Monetize your   <br className='sm:block hidden' /> {" "}
                        <span
                            className='text-gradient'>Authenticity  </span> {" "}
                    </h1>
                </div>
                <h1 className='font-poppins font-semibold ss:text-[62px] ph:text-[45px] bph:text-[39px] text-[52px] dark-text ss:leading-[80px] leading-[50px] w-full'> As a conversation partner</h1>
                <p className={`${styles.paragraph} max-w-[690px] mt-10 mb-5 dark-text `}>
