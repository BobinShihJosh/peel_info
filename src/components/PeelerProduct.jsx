...
const PeelerProduct = () => (
  <section id="product" className={layout.sectionReverse}>
    ...
    <div className={` ${layout.sectionInfo}  `}>
      <h2 className={` ${styles.heading2} dark-text  bph:text-[28px]  leading-[39px] xl:ml-[50px] `}>
      ...
      <p className={`${styles.paragraph} dark-text xl:ml-[50px] max-w-[570px] mt-5`}>
        <ol>
          ...
          <li>3. Go to settings and click on "Apply to be a Peeler!"</li>
        </ol>
      </p>
